...
TEST (Triangles, Is_Segment)
{
    ...
    EXPECT_TRUE (is_segment (tr_21));

    Triangle tr_22{pt_21, pt_31, pt_21};
    EXPECT_TRUE (is_segment (tr_22));

    Triangle tr_23{pt_31, pt_21, pt_21};
    EXPECT_TRUE (is_segment (tr_23));

    Point_3D pt_3{6020.412, 0.004691, -41769.1245};

    Triangle tr_3{pt_3, pt_3, pt_3};
    EXPECT_TRUE (is_segment (tr_3));
