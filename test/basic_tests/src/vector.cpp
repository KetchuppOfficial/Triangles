...
{
    Vector null {0.0};
    EXPECT_TRUE (yLab::cmp::is_zero (null.module()));

    Vector vec_1{1.0, 2.0, 3.0};
    EXPECT_TRUE (yLab::cmp::are_equal (vec_1.module(), 3.74165738));

    Vector vec_2{1.0, 1.0, 1.0};
    EXPECT_TRUE (yLab::cmp::are_equal (vec_2.module(), 1.73205081));

    constexpr double really_big_number = 1563413432.2;
    Vector vec_3{1.0, 1.0, really_big_number};
    EXPECT_TRUE (yLab::cmp::are_equal (vec_3.module(), really_big_number));

    Vector vec_4{-2.0, -3.0, 6.0};
    EXPECT_TRUE (yLab::cmp::are_equal (vec_4.module(), 7.0));

    Vector vec_5{12.0, 16.0, 21.0};
    EXPECT_TRUE (yLab::cmp::are_equal (vec_5.module(), 29.0));
}
...
TEST (Vectors, Ctor_From_Points)
{
    ...
    Point_3D remote_pt_1{100000001.0};
    Point_3D remote_pt_2{100000000.0};
