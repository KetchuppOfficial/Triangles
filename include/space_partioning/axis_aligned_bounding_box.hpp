#ifndef INCLUDE_OPTIMISATION_AXIS_ALIGNED_BOUNDING_BOX_HPP
#define INCLUDE_OPTIMISATION_AXIS_ALIGNED_BOUNDING_BOX_HPP
...
#endif // INCLUDE_OPTIMISATION_AXIS_ALIGNED_BOUNDING_BOX_HPP
